...
<head>
    <meta charset="UTF-8">
    <title>Настройка страницы корпоративных обедов</title>
    <style>
...
<body>
    <div class="container">
        <h1>Настройка страницы "Горячие обеды для офисов и детских садов"</h1>
        
        <?php
        $page_slug = 'corporate-meals';
        $page_title = 'Горячие обеды для офисов и детских садов';
        ...
        if (!$pattern_exists) {
            ...
            echo '<div class="info">Убедитесь, что файл <code>corporate-meals.php</code> загружен в папку <code>wp-content/themes/gustolocal/patterns/</code></div>';
        } else {
        ...
        <hr>
        <div class="info">
            <strong>Важно:</strong> После проверки страницы удалите этот файл (<code>setup-corporate-meals.php</code>) из соображений безопасности.
        </div>
