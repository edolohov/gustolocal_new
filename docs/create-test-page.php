<?php
/**
 * Скрипт для создания страницы "test" в WordPress
 * 
 * Использование:
 * 1. Откройте в браузере: https://gustolocal.es/create-test-page.php
 * 2. Скрипт создаст страницу со слагом "test" (если её ещё нет)
...
<head>
    <meta charset="UTF-8">
    <title>Создание страницы test</title>
    <style>
...
<body>
    <h1>Создание страницы "test"</h1>
    
    <?php
    $page_slug = 'test';
    $page_title = 'Тестовый набор';
